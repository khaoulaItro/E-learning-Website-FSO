  ...
  <header>
    ...
    <nav>
      <ul>
        ...
        <a href="cours.php">
          <li><button class="inscription">cours</button></li>
        </a>
  ...
  <div class="contact">
    ...
    <div>
      ...
      <p>
        ...
        <a class="links" href="#">khaoula.itro@ump.ac.ma</a><br><br>
        <a class="links" href="#">fso@oujda.com</a><br><br>
      </p><br>
      <h3>FSO oujda</h3>
      <p>faculté des Sciences ,<br>oujda - Maroc</p>
    </div>
  </div>
    ...
    <div class="content-footer">
      ...
      <div class="content-about">
        <a href="#" style="font-size: 20px; font-weight: 300; font-family: Georgia, 
              'Times New Roman', Times, serif; color: aliceblue;">cours</a>
