    ...
    <div class="headerr">
        ...
        <div class="navv">
            <ul class="ull">
                ...
                <a href="cours.php">
                    <li class="lii"><button class="inscription">cours</button></li>
                </a>
                <a href="includes/deconnexion.php">
                    <li class="lii"><button class="connection">deconnexion</button></li>
                </a>
                <?php
    ...
    <div class="container">
        ...
        <div class="container-matiere">
            ...
            <ul>
                ...
                <li><a href="?id=mongodb" id="mongodb" name="mongodb">mongodb</a>
                </li>
